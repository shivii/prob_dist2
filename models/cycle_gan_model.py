...
class CycleGANModel(BaseModel):
    ...
    def backward_D_basic(self, netD, real, fake, opt, js_div):
        ...
        if opt.advloss!=0:    
            ...
            loss_D_fake = 2 * js_div - torch.log(4)
    ...
    def backward_D_A(self, opt):
        ...
        self.loss_D_A = self.backward_D_basic(self.netD_A, self.real_B, fake_B, opt, js_div)

    def backward_D_B(self, opt):
        """Calculate GAN loss for discriminator D_B"""
        fake_A = self.fake_A_pool.query(self.fake_A)
        self.loss_D_B = self.backward_D_basic(self.netD_B, self.real_A, fake_A, opt, js_div) 
    ...
    def backward_G(self, opt, js_div_A_B, js_div_B_A):
        ...
        if opt.advloss != 0:
            ...
            self.loss_G_A = 2 * js_div_A_B - torch.log(4)
            self.loss_G_B = 2 * js_div_B_A - torch.log(4)

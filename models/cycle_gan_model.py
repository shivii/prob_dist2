...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        start = time.time()
        featA, lblA = get_patches.get_patch_list(self.real_A, self.real, 4)
        featB, lblB = get_patches.get_patch_list(self.real_B, self.real, 4)
        featCycleA, lblCycleA = get_patches.get_patch_list(self.fake_A, self.fake, 4)
        featCycleB, lblCycleB = get_patches.get_patch_list(self.fake_B, self.fake, 4)
        end = time.time()

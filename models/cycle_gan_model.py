...
class CycleGANModel(BaseModel):
    ...
    def backward_G(self):
        ...
        featA, lblA = self.get_neighb_list(self.real_A, self.real)
        featB, lblB = self.get_neighb_list(self.real_B, self.real)
        featCycleA, lblCycleA = self.get_neighb_list(self.fake_A, self.fake)
        featCycleB, lblCycleB = self.get_neighb_list(self.fake_B, self.fake)

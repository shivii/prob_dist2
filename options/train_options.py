...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--klloss', typinte=int, default=2, help="kl divergence loss is excluded in loss function if passed 0, klloss = kl if 1, js if 2")
        ...
        parser.add_argument('--which_pdf', type=str, default="6", help="comma seperated list of losses 1:gaussian,2:hist,3:wt_hist,4:imagePDF,5:patch_imagePDF,6:combination of 2,4")
        self.isTrain = True
        return parser
